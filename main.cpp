...
int main(){
    ...
    vector<vector<float>> Station_position_L1 = {{0,0}, {200, 0}, {823,0}, {1500, 0}, {1700,0}, {2.5, 2.5}, {3,3}, {3.5, 3.5}, {4,4}, {4.5, 4.5}, {5,5}, {5.5, 5.5}, {6,6}, {6.5, 6.5}, {7,7}, {7.5, 7.5}, {8,8}, {8.5, 8.5}, {9,9}};
