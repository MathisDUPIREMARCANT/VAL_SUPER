...
int main(){
    ...
    vector<vector<double>> Station_position_L1 = {{0,0}, {600, 400}, {700,700}, {1200, 1200}, {1700,1700}, {2000, 2000}, {3,3}, {3.5, 3.5}, {4,4}, {4.5, 4.5}, {5,5}, {5.5, 5.5}, {6,6}, {6.5, 6.5}, {7,7}, {7.5, 7.5}, {8,8}, {8.5, 8.5}, {9,9}};
    ...
    thread thread1(move_rame, Rame1, 100, 1.3, 4);
